...
with open("c:/Users/h1z1a/Desktop/Analyzeio/scratch/model_selection_text.txt", "w", encoding="utf-8") as f_out:
    f_out.writelines(output)

print("Model selection text references written to scratch/model_selection_text.txt")
